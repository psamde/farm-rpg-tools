...
$('confirmClearPlan').onclick=()=>{
 ...
 state.targets={};state.secondary=[];state.automatic_areas=null;state.guided_skipped=[];state.map_voided=[];state.map_use_void=[];state.map_hidden=[];state.map_expanded_areas=[];state.map_unused_mode='top';state.quest_selection=[];state.inventory='{}';state.passive_inventory='{}';
